...
var require_generated = __commonJS({
  "../../node_modules/@babel/types/lib/validators/generated/index.js"(exports) {
    ...
    exports.isMemberExpression = isMemberExpression3;
...
var traverseFn = typeof traverse === "function" ? traverse : traverse.default;
...
var traverse2 = resolveBabelModule(_traverse);
...
// src/plugins/vite-plugin-extract-router/route.ts
var traverse3 = resolveBabelModule(_traverse2);
...
var traverse4 = resolveBabelModule2(_traverse3);
...
var tagger = async (code, id, subPath, config, viteConfig) => {
  try {
    ...
    if (config.isAtomComponentPath(subPath)) {
      ...
      const exports = defaultExport ? namedExports.concat([defaultExport]) : namedExports;
...
export {
  ...
  fontsCodePlugin,
  vite_plugin_inject_domain_default as injectDomainPlugin,
  vite_plugin_inject_onerror_default as injectOnErrorPlugin,
  injectedGuiListenerPlugin,
  vite_plugin_location_route_default as locationRoutePlugin,
  makeTagger,
  mdClickPlugin,
  miaodaDevPlugin,
